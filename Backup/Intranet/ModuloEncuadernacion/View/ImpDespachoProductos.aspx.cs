...
{
    public partial class ImpDespachoProductos : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {

            Controller_Enc Enc = new Controller_Enc();
            Productos pro = Enc.ImprimirEtiquetaDespacho(Request.QueryString["cod"], Request.QueryString["op"]);
            ...
            if (pro.Codigo != "")
            {
                ...
                lblValidado.Text = pro.validado;

                DateTime fv = Convert.ToDateTime(pro.fechavalidacion);
                lblFechaValidacion.Text = fv.ToString("dd/MM/yyyy HH:mm");
