<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalleDevolucionPorOT.aspx.cs" Inherits="Intranet.ModuloDespacho.View.DetalleDevolucionPorOT" %>
...
<body>
    ...
    <div align="center">
        <asp:Label ID="Label1" runat="server" Text="Devolución Desde Cliente" 
            ...
            <tr>
                <td class="style3">
                    <asp:Label ID="Label13" runat="server" Font-Bold="True" Font-Size="Large" 
                        Text="Creada Por:"></asp:Label>
                </td>
                <td class="style5" colspan="2">
                    <asp:Label ID="lblCreadaPor" runat="server" Font-Bold="True" Font-Size="Large"></asp:Label>
&nbsp;&nbsp;
                    <asp:Label ID="lblFechaCreacion" runat="server" Font-Bold="True" 
                        Font-Size="Large"></asp:Label>
                    .</td>
            </tr>
            <tr>
