<%@ Page Title="" Language="C#" MasterPageFile="~/View/Aplicaciones.Master" AutoEventWireup="true" CodeBehind="RecepcionDesdeCliente.aspx.cs" Inherits="Intranet.ModuloDespacho.View.RecepcionDesdeCliente" %>
...
<%--   <div align="center" style="width: 1139px">
    <h3 style="color: rgb(23, 130, 239);">Devolución Desde Cliente</h3>
   </div>--%>
           ...
           <tr>
               <td class="style21" colspan="4">
                   ...
                   <asp:Label ID="Label1" runat="server" 
                       Text="* Este tipo de devolución sólo afecta al Informe por OT" 
