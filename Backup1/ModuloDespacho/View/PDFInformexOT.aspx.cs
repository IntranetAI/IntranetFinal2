...
{
    public partial class PDFInformexOT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            VariasPaginas(NumeroOT, NomOT, FI, FT);
        }
        ...
        //Se genera el PDF
        public void VariasPaginas(string OT, string NombreOT, string FI, string FT)
        {            //inicio variables
            int CantGuias = 0;
            string tirajeTotal = "";
            int totalDesp = 0;
            ...
            //fin variables
            List<DespachoPDF> lista = ListDespacho(OT, NombreOT, FI, FT);
            ...
            if (FI == "01/01/1900" || FT == ":01/01/1900")
            {
                info = "INFORME DESPACHOS POR OT \nOT : " + OT + " ";// Nombre : " + NombreOT + "
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=InformePorOT_" + OT.ToString() + ".pdf");
        ...
        public class itsEvents : PdfPageEventHelper
        {
            ...
            public override void OnEndPage(PdfWriter writer, Document document)
            {
                ...
                Phrase p4Header = new Phrase(String.Format("Cliente"), time);//FontFactory.GetFont("arial", 10));
