<%@ Page Title="" Language="C#" MasterPageFile="~/View/Aplicaciones.Master" AutoEventWireup="true" CodeBehind="ReimpresionFolio.aspx.cs" Inherits="Intranet.ModuloDespacho.View.ReimpresionFolio" %>
        ...
        <tr>
            ...
            <td class="style10">
                ...
                <asp:Label ID="Label2" runat="server" Font-Bold="True" 
                    Text="Reimprimir Devolucion Por:"></asp:Label>
&nbsp;&nbsp;&nbsp;
