...
{
    public partial class DetalleFacturaEnvio : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RadGrid1.DataSource = cf.Listar_DetalleFacturasEnvio("", Request.QueryString["emi"], Request.QueryString["folio"], "", "", "", 3);
            RadGrid1.DataBind();
        }
    }
}