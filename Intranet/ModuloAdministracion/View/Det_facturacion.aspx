<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Det_facturacion.aspx.cs" enableEventValidation="false"
    Inherits="Intranet.ModuloAdministracion.View.Det_facturacion" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function newRespuesta(id) {
            ...
            $.ajax({
                url: "Det_facturacion.aspx/Cargar_referenciaMensaje",
                type: "post",
                dataType: "json",
        ...
        function CrearRespuesta() {
            ...
            $.ajax({
                url: "Det_facturacion.aspx/CrearRespuesta",
                type: "post",
                dataType: "json",
                contentType: "application/json;charset=utf-8",
        ...
        function imprimir() {
            ...
            window.open('Det_facturacion_print.aspx?id=' + OT, 'Imprimir', 'left=160,top=100,width=1020 ,height=770,scrollbars=no,dependent=no,toolbar=no,location=no,status=no,directories=no,menubar=no,status=no,resizable=yes');
        }
        ...
        function contar() {
            ...
            for (x = 0; x < elementos.length; x++) {
                if (elementos[x].checked) {
                    $.ajax({
                        url: "Det_facturacion.aspx/NoLeido",
                        type: "post",
                        dataType: "json",
                        contentType: "application/json;charset=utf-8",
                ...
                window.location.href = 'Det_facturacion.aspx?ot=' + OT.trim();
            }
        }
        ...
        function MostrarDivListMensaje() {
            var titulo = document.getElementById("Label2").innerHTML;
            var OT = titulo.slice(4, titulo.search("-")).trim();
            location.href='Det_facturacion.aspx?OT=' + OT + '&Mensajeria=1';
        ...
        function CrearMensaje() {
            ...
            $.ajax({
                url: "Det_facturacion.aspx/CrearMensaje",
                type: "post",
                dataType: "json",
                contentType: "application/json;charset=utf-8",
        ...
        $(document).ready(function () {
            ...
            $("#TabContainer2_TabPanel1_ddlCategoria").change(function () {
                ...
                if (categoria != "Seleccionar") {
                    ...
                    $.ajax({
                        url: "Det_facturacion.aspx/CargarAsuntosMensajes",
                        type: "post",
                        dataType: "json",
                        contentType: "application/json;charset=utf-8",
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" Height="650px"
            Width="1100px">
            <asp:TabPanel ID="TabPapel0" runat="server" HeaderText="Facturación">
                <HeaderTemplate>
                    Facturación</HeaderTemplate>
                <ContentTemplate>
                <a href="javascript:imprimir()"><asp:Image ID="Image3" runat="server" ImageUrl="~/Images/print-message.jpg" Width="25px" /></a> 
                    <div style="width: 1085px;" align="center">
                        Consumos de Papel</div>
                    <div style="border: 1px solid blue; max-height: 450px; overflow-y: scroll; width: 1080px;">
                        <telerik:RadGrid ID="RadGridRF" BorderWidth="0px" runat="server" Skin="Outlook" GridLines="None">
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="CodItem">
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="Lote" HeaderText="Lote" ReadOnly="True" SortExpression="Lote"
                                        UniqueName="Lote">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="CodItem" HeaderText="Cod Item" SortExpression="CodItem"
                                        UniqueName="CodItem">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="NombrePapel" HeaderText="Nombre Papel" UniqueName="NombrePapel">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Gramage" HeaderText="Gr." SortExpression="Gramage"
                                        UniqueName="Gramage">
                                    ...
                                    <telerik:GridBoundColumn DataField="Cons_Pliego" HeaderText="Cons. Pliego" ReadOnly="True"
                                        SortExpression="Cons_Pliego" UniqueName="Cons_Pliego">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Cons_Bobina" HeaderText="Cons. Bobina" 
                                        UniqueName="Cons_Bobina">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Certif" HeaderText="Certificación" SortExpression="Certif"
                                        UniqueName="Certif">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="CostUni" HeaderText="Costo Unitario" SortExpression="CostUni"
                                        UniqueName="CostUni">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Costtot" HeaderText="Costo Total" SortExpression="Costtot"
                                        UniqueName="Costtot">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                </Columns>
                    ...
                    <table style="margin-left: 532px; width: 550px; text-align: center;" border="1">
                        <tr>
                            <td>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="text-align: left;">
                                <asp:Label ID="lblOperacion" runat="server" Text="Total"></asp:Label>
                            </td>
                            <td style="text-align: right;">
                                <asp:Label ID="lblPliego" runat="server" Text="0.00"></asp:Label>
                            </td>
                            <td style="text-align: right;">
                                <asp:Label ID="lblBobina" runat="server" Text="0.00"></asp:Label>
                            </td>
                            <td style="text-align: right;">
                    ...
                    <br />
                    <div id="RadGridPlanchaTit" runat="server" style="width: 1085px;" align="center">
                        Consumos de Planchas</div>
                    <div id="RadGridPlanchadiv" runat="server" style="border: 1px solid blue; max-height: 450px;
                        overflow-y: scroll; width: 1080px;">
                        <telerik:RadGrid ID="RadGridPlanchas" BorderWidth="0px" runat="server" Skin="Outlook"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="CodItem">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="NombrePapel" HeaderText="Descripción" UniqueName="NombrePapel">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Cons_Plancha" HeaderText="Cantidad" ReadOnly="True"
                                        SortExpression="Cons_Plancha" UniqueName="Cons_Plancha">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="CostUni" HeaderText="Costo Unitario" SortExpression="CostUni"
                                        UniqueName="CostUni">
                    ...
                    <table id="tablaPlancha" runat="server" style="margin-left: 532px; width: 550px;
                        ...
                        <tr runat="server">
                            ...
                            <td style="text-align: right;" runat="server">
                                <asp:Label ID="lblPlancha" runat="server" Text="0.00"></asp:Label>
                            </td>
                            <td style="text-align: right;" runat="server">
                                <asp:Label ID="lblTotalplc" runat="server" Text="0.00"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <br />
                    <div id="DivTitServExt" runat="server" style="width: 1085px;" align="center">
                        Servicios Externos</div>
                    <div id="DivSerExterno" runat="server" style="border: 1px solid blue; max-height: 450px;
                        overflow-y: scroll; width: 1080px;">
                        <telerik:RadGrid ID="RadGridSerExterno" BorderWidth="0px" runat="server" Skin="Outlook"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="CodItem">
                                ...
                                <CommandItemSettings ExportToPdfText="Export to Pdf" />
                                <Columns>
                                    <telerik:GridBoundColumn DataField="Lote" HeaderText="Descripción Proceso" ReadOnly="True"
                                        SortExpression="Lote" UniqueName="Lote">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Cons_Plancha" HeaderText="Componente" ReadOnly="True"
                                        SortExpression="Cons_Plancha" UniqueName="Cons_Plancha">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="CodItem" HeaderText="Aplicación" SortExpression="CodItem"
                                        UniqueName="CodItem">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="Certif" HeaderText="Cantidad" SortExpression="Certif"
                                        UniqueName="Certif">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="CostUni" HeaderText="Costo Unitario" SortExpression="CostUni"
                    ...
                    <table id="TablaSerExter" runat="server" style="margin-left: 532px; width: 550px;
                        text-align: center;" border="1">
                        <tr runat="server">
                            <td runat="server" class="style20">
                            </td>
                            <td runat="server" class="style20">
                                Costo Total
                            </td>
                        ...
                        <tr runat="server">
                            ...
                            <td style="text-align: right;" runat="server">
                                <asp:Label ID="lblTotalSerExt" runat="server" Text="0.00"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <br />
                    <div id="RadGridOtrosTit" runat="server" style="width: 1085px;" align="center">
                        Otros Consumos</div>
                    <div id="RadGridOtrosdiv" runat="server" style="border: 1px solid blue; max-height: 450px;
                        overflow-y: scroll; width: 1080px;">
                        <telerik:RadGrid ID="RadGridOtros" BorderWidth="0px" runat="server" Skin="Outlook"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="CodItem">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="NombrePapel" HeaderText="Nombre Material" UniqueName="NombrePapel">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Cons_Otros" HeaderText="Cons. Otros" ReadOnly="True"
                                        SortExpression="Cons_Otros" UniqueName="Cons_Otros">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="CostUni" HeaderText="Costo Unitario" SortExpression="CostUni"
                                        UniqueName="CostUni">
                    ...
                    <table id="TableOtros" runat="server" style="margin-left: 532px; width: 550px; text-align: center;"
                        border="1">
                        <tr runat="server">
                            <td runat="server">
                            </td>
                        ...
                        <tr runat="server">
                            ...
                            <td style="text-align: right;" runat="server">
                                <asp:Label ID="lblOtros" runat="server" Text="0.00"></asp:Label>
                            </td>
                            <td style="text-align: right;" runat="server">
                                <asp:Label ID="lblTotalOtros" runat="server" Text="0.00"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
                        ...
                        <telerik:RadGrid ID="RadGrid4" runat="server" Skin="Outlook">
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="OT">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Cant" HeaderText="Cant. a Despachar" ItemStyle-HorizontalAlign="Right"
                                        ItemStyle-Width="50px" UniqueName="Cant">
                                    </telerik:GridBoundColumn>
