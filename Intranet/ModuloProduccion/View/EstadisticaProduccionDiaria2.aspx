<%@ Page Title="" Language="C#" MasterPageFile="~/View/Aplicaciones.Master" AutoEventWireup="true" CodeBehind="EstadisticaProduccionDiaria2.aspx.cs" Inherits="Intranet.ModuloProduccion.View.EstadisticaProduccionDiaria2" %>
...
<table style="background-color:#EEE;border:1px solid #999;margin-left:70px;border-radius:10px 10px 10px 10px;" align="center" width="950px">
    ...
    <asp:Label ID="lblGrid1" runat="server"></asp:Label>
     ...
     <div runat="server" style="height:600px;overflow:auto;">
             ...
             <telerik:radgrid ID="RadGrid1" runat="server" Skin="Outlook" >
                 <MasterTableView AutoGenerateColumns="False" DataKeyNames="semana">
                     ...
                     <Columns>
                         <telerik:GridBoundColumn DataField="Semana" HeaderText="Dia" ItemStyle-Width="10px" ItemStyle-HorizontalAlign="Right" SortExpression="Semana" UniqueName="Semana">
