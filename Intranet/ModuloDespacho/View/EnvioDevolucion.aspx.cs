...
{
    public partial class EnvioDevolucion : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            if (rdFolio.Checked == true)
            {
                RadGrid1.DataSource = des.BusquedaPorFolioyOT(txtFolio.Text, txtOT.Text, 1);
                RadGrid1.DataBind();
            ...
            else if (rdOT.Checked == true)
            {
                ...
                RadGrid1.DataSource = des.BusquedaPorFolioyOT(txtFolio.Text, txtOT.Text, 2);
                RadGrid1.DataBind();
                divBotones.Visible = false;
        ...
        protected void btnGenerar_Click(object sender, EventArgs e)
        {
            if (txtFolio.Text != "")
            {
                bool r = des.GenerarEnvio(txtFolio.Text, Session["Usuario"].ToString());
