<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImpDespachoProductos.aspx.cs" Inherits="Intranet.ModuloEncuadernacion.View.ImpDespachoProductos" %>
...
<body onload="window.print();">
    ...
    <div align="center">
        ...
        <asp:Label ID="Label26" runat="server" Font-Bold="True" Font-Size="XX-Large" 
            Text="Orden de Entrega a Despacho Impresión"></asp:Label>
        <br />
        <br />
        ...
        <tr>
            <td class="style2" align="center">
                <asp:Label ID="Label27" runat="server" Font-Bold="True" Font-Size="Large" 
                    Text="Revisado y Validado Por:"></asp:Label>
            </td>
            <td  colspan="2">
                <asp:Label ID="lblValidado" runat="server" Font-Size="Large"></asp:Label>
&nbsp;
                <asp:Label ID="lblFechaValidacion" runat="server" Font-Size="Large"></asp:Label>
            </td>
        </tr>
    </table>
    </form>
