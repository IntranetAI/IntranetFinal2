<%@ Page Title="" Language="C#" MasterPageFile="~/View/index.Master" AutoEventWireup="true" CodeBehind="Informe_Gemba.aspx.cs" Inherits="Intranet.ModuloRFrecuencia.View.Informe_Gemba" %>
...
<%--<h3 style="color: rgb(23, 130, 239);text-align:center;width:940px;margin-top:-10px;">Informe Gemba</h3>--%>
        ...
        <div runat="server" id="divbotones" style="text-align:right; width: 945px; margin-top:-20px; margin-left:-10px;" >
   ...
   <%--&nbsp;&nbsp;&nbsp;<a title="Exportar a PDF"><asp:ImageButton 
    ...
    <table style="background-color:#EEE;border:1px solid #999;padding:5px;margin-left:-10px;margin-bottom:5px;border-radius:10px 10px 10px 10px;" align="center" width="948px">
        ...
        <asp:Panel ID="Panel1" runat ="server" Height="600px" Width="940px" Direction="NotSet" ClientIDMode="Inherit">
