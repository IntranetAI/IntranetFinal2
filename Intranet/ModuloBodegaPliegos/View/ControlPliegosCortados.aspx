<%@ Page Title="" Language="C#" MasterPageFile="~/View/Aplicaciones.Master" AutoEventWireup="true" CodeBehind="ControlPliegosCortados.aspx.cs" Inherits="Intranet.ModuloBodegaPliegos.View.ControlPliegosCortados" %>
...
<table style="background-color:#EEE;border:1px solid #999;margin-left:12%;border-radius:10px 10px 10px 10px; width: 825px;" 
        ...
        <tr>
               <td class="style4">
               &nbsp;&nbsp;
                   <asp:Label ID="Label10" runat="server" Text="Numero OP:"></asp:Label>
            ...
            <td class="style4">
                <asp:Label ID="Label11" runat="server" Text="Nombre OP:"></asp:Label>
               </td>
            <td class="style4">
        ...
        <telerik:radgrid ID="RadGrid1" runat="server" 
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="NumeroTicket" HeaderText="FechaSolicitud" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" SortExpression="NumeroTicket" UniqueName="NumeroTicket">
                    </telerik:GridBoundColumn>
                        
             
                    <telerik:GridBoundColumn DataField="NumeroOP" HeaderText="NumeroOP" ItemStyle-Width="160px" SortExpression="NumeroOP" UniqueName="NumeroOP">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="CantSolicitadaFL" HeaderText="CantSolicitadaFL" ItemStyle-Width="50px" SortExpression="CantSolicitadaFL" UniqueName="CantSolicitadaFL">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="CantSolicitadaFL" HeaderText="CantProcesada" ItemStyle-Width="50px" SortExpression="CantSolicitadaFL" UniqueName="CantSolicitadaFL">
                    </telerik:GridBoundColumn>
